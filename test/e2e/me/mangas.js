...
describe('e2e me/mangas', function () {
  ...
  it('rejects if not existing manga', Mocker.mockIt(function (mokr) {
    const userId = '0'.repeat(24)
    const token = 'abc'
    return Promise.all([
      UserModel.create({ _id: userId, googleId: 'g', displayName: 'moran' }),
  ...
  it('patches my manga collection', Mocker.mockIt(function (mokr) {
    const userId = '0'.repeat(24)
    const token = 'abc'
    const mangas = {
      dbz: 5,
  ...
  it('gives me back my failing mangas', Mocker.mockIt(function (mokr) {
    const userId = '0'.repeat(24)
    const token = 'abc'
    const mangas = {
      dbz: 5,
  ...
  it('fetches my collection', Mocker.mockIt(function (mokr) {
    const userId = '0'.repeat(24)
    const token = 'abc'
    const mangas = {
      dbz: 5,
